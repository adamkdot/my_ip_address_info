...
public class ProxySettingsFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((RadioButton)rootView.findViewById(R.id.proxySettingsRadioNone)).setChecked(!useProxy);
   		((RadioButton)rootView.findViewById(R.id.proxySettingsRadioTor)).setChecked(useProxy && (proxyPort == HTTP_PROXY_PORT_TOR));
   		((RadioButton)rootView.findViewById(R.id.proxySettingsRadioPsiphon)).setChecked(useProxy && (proxyPort == HTTP_PROXY_PORT_PSIPHON));
	...
	private void updateProxyPreferences() {
		...
		int proxyPort = PreferenceManager.getDefaultSharedPreferences(getActivity())
				.getInt(getResources().getString(R.string.PREFERENCE_PROXY_PORT), HTTP_PROXY_PORT_INVALID);
