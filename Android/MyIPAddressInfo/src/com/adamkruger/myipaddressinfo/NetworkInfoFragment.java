...
public class NetworkInfoFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_network_info,
				container, false);
		mNetworkInfoTableLayout = (TableLayout) rootView
				.findViewById(R.id.networkInfoTableLayout);
		populateInfo();
		return rootView;
	}
	...
	public void populateInfo() {
		...
		if (networkInfo != null) {
			...
			addTableRow(context, mNetworkInfoTableLayout,
					networkInfo.getTypeName(), state);
			addTableRow(context, mNetworkInfoTableLayout,
					networkInfo.getSubtypeName(), detailedState);
			addTableRow(context, mNetworkInfoTableLayout,
					networkInfo.getExtraInfo(), reason);
		}
	}

	private void addTableRow(Context context, TableLayout tableLayout,
	...
	private TableRow makeTableRow(Context context, String label, String value) {
		...
		labelTextView.setLayoutParams(new TableRow.LayoutParams(
				TableRow.LayoutParams.WRAP_CONTENT,
				TableRow.LayoutParams.WRAP_CONTENT));
		labelTextView.setTextAppearance(context,
				android.R.attr.textAppearanceSmall);
		labelTextView.setTextColor(getResources().getColor(
		...
		valueTextView.setLayoutParams(new TableRow.LayoutParams(
				TableRow.LayoutParams.WRAP_CONTENT,
				TableRow.LayoutParams.WRAP_CONTENT));
		valueTextView.setTextAppearance(context,
				android.R.attr.textAppearanceSmall);
